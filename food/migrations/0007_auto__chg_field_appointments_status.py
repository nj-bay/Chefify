...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Appointments.status'
        db.alter_column(u'food_appointments', 'status', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True))

    def backwards(self, orm):

        # Changing field 'Appointments.status'
        db.alter_column(u'food_appointments', 'status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
    ...
    models = {
        ...
        u'food.appointments': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['food.Location']", 'null': 'True', 'blank': 'True'}),
            ...
            'status': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True'})
        },
        u'food.chef': {
