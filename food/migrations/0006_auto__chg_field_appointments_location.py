...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Appointments.location'
        db.alter_column(u'food_appointments', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['food.Location'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Appointments.location'
        raise RuntimeError("Cannot reverse this migration. 'Appointments.location' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Appointments.location'
        db.alter_column(u'food_appointments', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['food.Location']))
    ...
    models = {
        ...
        u'food.appointments': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['food.Location']", 'null': 'True'}),
