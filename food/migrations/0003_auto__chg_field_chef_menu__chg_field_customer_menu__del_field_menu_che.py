...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chef.menu'
        db.alter_column(u'food_chef', 'menu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['food.Menu'], null=True))

        # Changing field 'Customer.menu'
        db.alter_column(u'food_customer', 'menu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['food.Menu'], null=True))
        # Deleting field 'Menu.chef_id'
        db.delete_column(u'food_menu', 'chef_id_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Chef.menu'
        raise RuntimeError("Cannot reverse this migration. 'Chef.menu' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Chef.menu'
        db.alter_column(u'food_chef', 'menu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['food.Menu']))

        # User chose to not deal with backwards NULL issues for 'Customer.menu'
        raise RuntimeError("Cannot reverse this migration. 'Customer.menu' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Customer.menu'
        db.alter_column(u'food_customer', 'menu_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['food.Menu']))

        # User chose to not deal with backwards NULL issues for 'Menu.chef_id'
        raise RuntimeError("Cannot reverse this migration. 'Menu.chef_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Menu.chef_id'
        db.add_column(u'food_menu', 'chef_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='menus', to=orm['food.Chef']),
                      keep_default=False)
