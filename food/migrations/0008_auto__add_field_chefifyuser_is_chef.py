...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChefifyUser.is_chef'
        db.add_column(u'food_chefifyuser', 'is_chef',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChefifyUser.is_chef'
        db.delete_column(u'food_chefifyuser', 'is_chef')
    ...
    models = {
        ...
        u'food.chefifyuser': {
            ...
            'is_chef': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
