...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field cuisine on 'Chef'
        m2m_table_name = db.shorten_name(u'food_chef_cuisine')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('chef', models.ForeignKey(orm[u'food.chef'], null=False)),
            ('cuisine', models.ForeignKey(orm[u'food.cuisine'], null=False))
        ))
        db.create_unique(m2m_table_name, ['chef_id', 'cuisine_id'])


    def backwards(self, orm):
        # Removing M2M table for field cuisine on 'Chef'
        db.delete_table(db.shorten_name(u'food_chef_cuisine'))
    ...
    models = {
        ...
        u'food.appointments': {
            ...
            'menu': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['food.Menu']"}),
