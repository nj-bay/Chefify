...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Chef.name'
        db.delete_column(u'food_chef', 'name')

        # Adding field 'Chef.restaurant'
        db.add_column(u'food_chef', 'restaurant',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Chef.name'
        db.add_column(u'food_chef', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Deleting field 'Chef.restaurant'
        db.delete_column(u'food_chef', 'restaurant')
